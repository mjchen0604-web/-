...
const DefaultPanelGitHubRepository = ""
const DefaultCodexReasoningEffort = "medium"
const DefaultCodexReasoningSummary = "auto"
const DefaultCodexReasoningCompat = "think-tags"
...
type Config struct {
	...
	// CodexSettings defines Codex-only command settings.
	CodexSettings CodexSettings `yaml:"codex-settings" json:"codex-settings"`
...
// CodexSettings defines Codex-only command defaults and toggles.
type CodexSettings struct {
	...
	ReasoningCompat       string `yaml:"reasoning-compat,omitempty" json:"reasoning-compat,omitempty"`
	DebugModel            string `yaml:"debug-model,omitempty" json:"debug-model,omitempty"`
	ExposeReasoningModels bool   `yaml:"expose-reasoning-models,omitempty" json:"expose-reasoning-models,omitempty"`
	EnableWebSearch       bool   `yaml:"enable-web-search,omitempty" json:"enable-web-search,omitempty"`
	CompatibilityMode     bool   `yaml:"compatibility-mode,omitempty" json:"compatibility-mode,omitempty"`
	Verbose               bool   `yaml:"verbose,omitempty" json:"verbose,omitempty"`
	VerboseObfuscation    bool   `yaml:"verbose-obfuscation,omitempty" json:"verbose-obfuscation,omitempty"`
}
...
func LoadConfigOptional(configFile string, optional bool) (*Config, error) {
	...
	cfg.CodexSettings.ReasoningEffort = DefaultCodexReasoningEffort
	cfg.CodexSettings.ReasoningSummary = DefaultCodexReasoningSummary
	cfg.CodexSettings.ReasoningCompat = DefaultCodexReasoningCompat
	...
	// Sanitize Codex command settings.
	cfg.CodexSettings = NormalizeCodexSettings(cfg.CodexSettings)
...
var codexReasoningEffortValues = map[string]struct{}{
	"minimal": {},
	"low":     {},
	"medium":  {},
	"high":    {},
...
var codexReasoningSummaryValues = map[string]struct{}{
	"auto":     {},
	"concise":  {},
	"detailed": {},
	"none":     {},
...
var codexReasoningCompatValues = map[string]struct{}{
	"legacy":     {},
	"o3":         {},
	"think-tags": {},
	"current":    {},
...
func normalizeCodexEnum(value, fallback string, allowed map[string]struct{}) string {
...
// NormalizeCodexSettings ensures Codex settings stay within supported values.
func NormalizeCodexSettings(settings CodexSettings) CodexSettings {
	out := settings
	out.ReasoningEffort = normalizeCodexEnum(out.ReasoningEffort, DefaultCodexReasoningEffort, codexReasoningEffortValues)
	out.ReasoningSummary = normalizeCodexEnum(out.ReasoningSummary, DefaultCodexReasoningSummary, codexReasoningSummaryValues)
	out.ReasoningCompat = normalizeCodexEnum(out.ReasoningCompat, DefaultCodexReasoningCompat, codexReasoningCompatValues)
	out.DebugModel = strings.TrimSpace(out.DebugModel)
	return out
}
